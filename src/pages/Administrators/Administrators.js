...
function Adminitrators() {
    ...
    <div className="body">
        ...
        <div class="mb-3">
            ...
            <select id="state"
                onChange={handleChangeSemeter} class="form-select mb-5" >
                    <option value= "ALL"> ALL </option>
                    {
                        uniqueSemeter.map((unique, i) => {
                            return(
                                <option value= {unique}> <SwitchCaseSemeter value={unique}/> </option>
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th width="350 px">Tên giảng viên
                        </th>
                        <th>Năm
                        </th>
                        <th>Học kỳ
